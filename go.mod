...
replace (
	...
	//github.com/contiv/ofnet => github.com/echkenluo/ofnet v0.0.0-20220413030501-4e4f91ab7cc3
	github.com/contiv/ofnet => github.com/cl1111/ofnet v0.0.0-20220505094759-34a2b3201b4a
