...
var (
	...
	policyForwardingTableFlows = []string{
		...
		"table=70, priority=100,ct_state=+rpl+trk,ct_label=0/0xffff000000000000000000000000000,ip actions=ct(commit,table=71,zone=NXM_NX_REG4[16..31],exec(move:NXM_NX_PKT_MARK[17..18]->NXM_NX_CT_LABEL[90..91],move:NXM_NX_PKT_MARK[0..15]->NXM_NX_CT_LABEL[108..123],load:0x3->NXM_NX_CT_LABEL[124..125]))",
		"table=70, priority=100,ct_state=+rpl+trk,ct_label=0/0xffff000000000000000000000000000,ipv6 actions=ct(commit,table=71,zone=NXM_NX_REG4[16..31],exec(move:NXM_NX_PKT_MARK[17..18]->NXM_NX_CT_LABEL[90..91],move:NXM_NX_PKT_MARK[0..15]->NXM_NX_CT_LABEL[108..123],load:0x3->NXM_NX_CT_LABEL[124..125]))",
	...
	policyForwardingTableALGFlows = []string{
		...
		"table=70, priority=103,ct_state=+rpl+trk,ct_label=0/0xffff000000000000000000000000000,tcp,tp_dst=21 actions=ct(commit,table=71,zone=NXM_NX_REG4[16..31],exec(move:NXM_NX_PKT_MARK[17..18]->NXM_NX_CT_LABEL[90..91],move:NXM_NX_PKT_MARK[0..15]->NXM_NX_CT_LABEL[108..123],load:0x3->NXM_NX_CT_LABEL[124..125]),alg=ftp)",
		"table=70, priority=103,ct_state=+rpl+trk,ct_label=0/0xffff000000000000000000000000000,tcp6,tp_dst=21 actions=ct(commit,table=71,zone=NXM_NX_REG4[16..31],exec(move:NXM_NX_PKT_MARK[17..18]->NXM_NX_CT_LABEL[90..91],move:NXM_NX_PKT_MARK[0..15]->NXM_NX_CT_LABEL[108..123],load:0x3->NXM_NX_CT_LABEL[124..125]),alg=ftp)",
		"table=70, priority=103,ct_state=+rpl+trk,ct_label=0/0xffff000000000000000000000000000,udp,tp_dst=69 actions=ct(commit,table=71,zone=NXM_NX_REG4[16..31],exec(move:NXM_NX_PKT_MARK[17..18]->NXM_NX_CT_LABEL[90..91],move:NXM_NX_PKT_MARK[0..15]->NXM_NX_CT_LABEL[108..123],load:0x3->NXM_NX_CT_LABEL[124..125]),alg=tftp)",
		"table=70, priority=103,ct_state=+rpl+trk,ct_label=0/0xffff000000000000000000000000000,udp6,tp_dst=69 actions=ct(commit,table=71,zone=NXM_NX_REG4[16..31],exec(move:NXM_NX_PKT_MARK[17..18]->NXM_NX_CT_LABEL[90..91],move:NXM_NX_PKT_MARK[0..15]->NXM_NX_CT_LABEL[108..123],load:0x3->NXM_NX_CT_LABEL[124..125]),alg=tftp)",
	}
)
...
func flowValidator(expectedFlows []string) error {
	...
	for _, expectedFlow := range expectedFlows {
		...
		expected := re.ReplaceAllString(expectedFlow, "load:0x->NXM_NX_XXREG0")
...
func TestPolicyBridgeFlows(t *testing.T) {
	...
	t.Run("test policy bridge ct drop flows", func(t *testing.T) {
		...
		Expect(currentTable71Flows).Should(Equal(policyCTDropTableFlows))
	...
	t.Run("test policy bridge ct state flows", func(t *testing.T) {
		...
		Expect(currentTable1Flows).Should(Equal(policyCTStateTableFlows))
	})
	...
	t.Run("test policy bridge direction selection flows", func(t *testing.T) {
		...
		Expect(currentTable10Flows).Should(Equal(policyDirectionSelectionTableFlows))
	})
	...
	t.Run("test policy bridge action update flows", func(t *testing.T) {
		...
		Expect(currentTable69Flows).Should(Equal(policyActionUpdateTableFlows))
	})
}
...
// FIXME: sort exec items to verify the refactor without changing test cases
