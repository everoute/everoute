...
var (
	...
	ctInputFlow                    = "table=0, priority=300,ip actions=move:NXM_OF_VLAN_TCI[0..11]->NXM_NX_REG4[16..27],load:0xe->NXM_NX_REG4[28..31],ct(table=1,zone=NXM_NX_REG4[16..31])"
	ctCommitFlow                   = "table=70, priority=200,ct_state=+new+trk,ip actions=ct(commit,table=71,zone=NXM_NX_REG4[16..31],exec(move:NXM_NX_XXREG0[]->NXM_NX_CT_LABEL[]))"
