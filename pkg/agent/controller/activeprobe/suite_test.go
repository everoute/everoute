...
import (
	...
	"github.com/everoute/everoute/pkg/agent/controller/activeprobe"
...
func TestActiveProbeController(t *testing.T) {
	RegisterFailHandler(Fail)
	RunSpecs(t, "ActivProbeController Suite")
}
...
var _ = BeforeSuite(func() {
	...
	*/
	...
	activeprobeController := &activeprobe.Controller{
		K8sClient:       k8sManager.GetClient(),
		Scheme:          k8sManager.GetScheme(),
		DatapathManager: datapathManager,
	}
	err = (activeprobeController).SetupWithManager(k8sManager)
	Expect(err).ToNot(HaveOccurred())
