...
func (r *LocalRule) DiffFromRuleCR(r2 *v1alpha1.Rule) bool {
	...
	if r.Direct == datapath.DirEgress && r2.Spec.Direct != v1alpha1.Egress {
		return true
	}
	if r.Direct == datapath.DirIngress && r2.Spec.Direct != v1alpha1.Ingress {
		return true
	}
...
func toLocalRule(r *v1alpha1.Rule) *LocalRule {
	...
	if r.Spec.Direct == v1alpha1.Egress {
		res.Direct = datapath.DirEgress
	}
	if r.Spec.Direct == v1alpha1.Ingress {
