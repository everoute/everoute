...
func NewControllerMetric() *ControllerMetric {
	return &ControllerMetric{
		...
		policyInfo:                 NewPolicyInfoMetric(),
...
func (c *ControllerMetric) Init() {
	...
	if err := c.reg.Register(c.policyInfo.data); err != nil {
		klog.Fatalf("Failed to init policyInfo metric %s", err)
	}
...
func (c *ControllerMetric) GetPolicyInfo() *PolicyInfoMetric {
	return c.policyInfo
}
