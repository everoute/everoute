...
func (in *K8sClusterSpec) DeepCopyInto(out *K8sClusterSpec) {
	*out = *in
	if in.SksOption != nil {
		in, out := &in.SksOption, &out.SksOption
		*out = new(SksOption)
		**out = **in
	}
	return
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SksOption) DeepCopyInto(out *SksOption) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SksOption.
func (in *SksOption) DeepCopy() *SksOption {
	if in == nil {
		return nil
	}
	out := new(SksOption)
