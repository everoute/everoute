...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EndpointNamespacedName) DeepCopyInto(out *EndpointNamespacedName) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EndpointNamespacedName.
func (in *EndpointNamespacedName) DeepCopy() *EndpointNamespacedName {
	if in == nil {
		return nil
	}
	out := new(EndpointNamespacedName)
	in.DeepCopyInto(out)
	return out
}
