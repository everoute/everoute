...
var endpointgroupsResource = schema.GroupVersionResource{Group: "group.lynx.smartx.com", Version: "v1alpha1", Resource: "endpointgroups"}

var endpointgroupsKind = schema.GroupVersionKind{Group: "group.lynx.smartx.com", Version: "v1alpha1", Kind: "EndpointGroup"}
...
func (c *FakeEndpointGroups) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.EndpointGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(endpointgroupsResource, name), &v1alpha1.EndpointGroup{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeEndpointGroups) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.EndpointGroupList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(endpointgroupsResource, endpointgroupsKind, opts), &v1alpha1.EndpointGroupList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeEndpointGroups) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(endpointgroupsResource, opts))
}
...
func (c *FakeEndpointGroups) Create(ctx context.Context, endpointGroup *v1alpha1.EndpointGroup, opts v1.CreateOptions) (result *v1alpha1.EndpointGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(endpointgroupsResource, endpointGroup), &v1alpha1.EndpointGroup{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.EndpointGroup), err
...
func (c *FakeEndpointGroups) Update(ctx context.Context, endpointGroup *v1alpha1.EndpointGroup, opts v1.UpdateOptions) (result *v1alpha1.EndpointGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(endpointgroupsResource, endpointGroup), &v1alpha1.EndpointGroup{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.EndpointGroup), err
...
func (c *FakeEndpointGroups) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(endpointgroupsResource, name), &v1alpha1.EndpointGroup{})
	return err
}
...
func (c *FakeEndpointGroups) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(endpointgroupsResource, listOpts)
...
func (c *FakeEndpointGroups) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.EndpointGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(endpointgroupsResource, name, pt, data, subresources...), &v1alpha1.EndpointGroup{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.EndpointGroup), err
