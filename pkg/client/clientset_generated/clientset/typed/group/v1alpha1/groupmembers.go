...
// GroupMembersesGetter has a method to return a GroupMembersInterface.
// A group's client should implement this interface.
type GroupMembersesGetter interface {
	GroupMemberses() GroupMembersInterface
}

// GroupMembersInterface has methods to work with GroupMembers resources.
type GroupMembersInterface interface {
	Create(ctx context.Context, groupMembers *v1alpha1.GroupMembers, opts v1.CreateOptions) (*v1alpha1.GroupMembers, error)
	Update(ctx context.Context, groupMembers *v1alpha1.GroupMembers, opts v1.UpdateOptions) (*v1alpha1.GroupMembers, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1alpha1.GroupMembers, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1alpha1.GroupMembersList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.GroupMembers, err error)
	GroupMembersExpansion
}

// groupMemberses implements GroupMembersInterface
type groupMemberses struct {
	client rest.Interface
}

// newGroupMemberses returns a GroupMemberses
func newGroupMemberses(c *GroupV1alpha1Client) *groupMemberses {
...
func (c *groupMemberses) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.GroupMembersList, err error) {
...
func (c *groupMemberses) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *groupMemberses) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
