...
var globalpoliciesResource = v1alpha1.SchemeGroupVersion.WithResource("globalpolicies")

var globalpoliciesKind = v1alpha1.SchemeGroupVersion.WithKind("GlobalPolicy")
...
func (c *FakeGlobalPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteActionWithOptions(globalpoliciesResource, name, opts), &v1alpha1.GlobalPolicy{})
	return err
}
