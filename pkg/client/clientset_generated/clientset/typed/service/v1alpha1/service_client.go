...
// ServiceV1alpha1Client is used to interact with features provided by the service.everoute.io group.
type ServiceV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ServiceV1alpha1Client) ServicePorts(namespace string) ServicePortInterface {
	return newServicePorts(c, namespace)
}
