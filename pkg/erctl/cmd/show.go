...
var showCmd = &cobra.Command{
	Use:   "show",
	Short: "specify which filed you want show",
	Long: `all struct field has been set 'json:",omitempty"', so the programme will set those field null value
[-D {fieldName...}] means don't show {fieldName...} (like blacklist)
