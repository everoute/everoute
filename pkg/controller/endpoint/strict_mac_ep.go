...
func (s *StrictMacController) Reconcile(req ctrl.Request) (ctrl.Result, error) {
...
func (s *StrictMacController) SetupWithManager(mgr ctrl.Manager) error {
	...
	return c.Watch(&source.Kind{Type: &securityv1alpha1.Endpoint{}}, &handler.EnqueueRequestForObject{}, predicate.Funcs{
